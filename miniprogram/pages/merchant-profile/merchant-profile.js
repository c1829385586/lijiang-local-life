Page({
  ...
  goStoreEdit() { wx.navigateTo({ url: '/pages/merchant-store-edit/merchant-store-edit?edit=1' }) },
  ...
  async toggleStatus() {
    ...
    try {
      await wx.cloud.callFunction({ name: 'merchant', data: { action: 'updateStore', storeData: { status: newStatus } } })
